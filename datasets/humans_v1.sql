-- Breadit human-like demo dataset (v1)
--
-- Source:
-- - apps/backend/prisma/migrations/20260507160000_data_humans_v1/migration.sql
-- - apps/backend/prisma/migrations/20260507163500_data_humans_v1_personal_posts/migration.sql
--
-- Usage (via npm script):
--   npm run dataset:humans
--
-- Notes:
-- - Append-only, idempotent (ON CONFLICT / WHERE NOT EXISTS)
-- - This is dataset import SQL (NOT a schema migration).
-- - Requires schema already migrated (tables User, Post, Community, Hashtag, etc.)

-- =====================================================================
-- Part 1: base humans_v1 (users, communities, rules, hashtags, posts...)
-- =====================================================================
...
-- =====================================================================
-- Part 2: patch personal posts for profile tabs (non-community)
-- =====================================================================
